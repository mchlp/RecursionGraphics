...
public class Vector {
	...
	/**
	 * Creates a backend.Vector object using magnitude and direction
	 * 
	 * @param magnitude
	 *            Magnitude of vector
	 * @param direction
	...
	/**
	 * Creates a backend.Vector object using X and Y components
	 * 
	 * @param xComponent
	...
	/**
	 * Adds two backend.Vector objects together and returns the sum
	 * 
	 * @param vector2
	 *            backend.Vector object to add
	 * @return backend.Vector object representing the sum
	 */
